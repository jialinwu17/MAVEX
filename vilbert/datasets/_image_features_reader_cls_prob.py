    ...
    def __getitem__(self, image_id):
        ...
        if self._in_memory:
            ...
            with self.env.begin(write=False) as txn:
                ...
                reader = np.load('/home/jialinw/vqa-maskrcnn-benchmark/outputs/%s.npy' % image_id, allow_pickle=True)
                cls_prob = reader.item().get("cls_prob")[:36].reshape(-1, 1601)
        ...
        return features, num_boxes, image_location, cls_prob
